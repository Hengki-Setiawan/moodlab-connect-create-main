    ...
    <div className="flex flex-col h-full">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto pr-2 space-y-1">
        ...
        <div className="pt-4 pb-2">
          ...
          <Link to="/admin-dashboard?tab=service-orders" onClick={() => setIsOpen(false)}>
            <Button
              variant="ghost"
              className={`w-full justify-start text-white hover:bg-white/10 ${currentTab === "service-orders" ? "bg-white/20 shadow-inner" : ""}`}
            >
              <Briefcase className="mr-3 h-5 w-5" />
              Service Orders
            </Button>
          ...
          <Link to="/admin-dashboard?tab=refunds" onClick={() => setIsOpen(false)}>
            <Button
              variant="ghost"
              className={`w-full justify-start text-white hover:bg-white/10 ${currentTab === "refunds" ? "bg-white/20 shadow-inner" : ""}`}
            >
              <FileText className="mr-3 h-5 w-5" />
              Refund Requests
            </Button>
