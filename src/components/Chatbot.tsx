            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-20 right-4 z-50 w-[350px] md:w-[400px] h-[500px] bg-background border rounded-xl shadow-2xl flex flex-col overflow-hidden"
                    >
                        {/* Header */}
                        <div className="bg-primary p-4 flex items-center justify-between text-primary-foreground">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <h3 className="font-semibold text-sm">Moodlab Assistant</h3>
