...
const consultationServices = [
  ...
  {
    name: 'Konsultasi Strategi Branding',
    description: 'Layanan konsultasi untuk membantu Anda membangun atau memperkuat identitas merek. Tim kami akan menganalisis positioning merek Anda di pasar, target audiens, dan kompetitor untuk memberikan rekomendasi strategi branding yang efektif dan konsisten di semua platform.',
    price: 950000,
    type: 'service',
    category: 'consultation',
    image_url: 'https://images.unsplash.com/photo-1559028012-481c04fa702d?q=80&w=1000&auto=format&fit=crop',
    stock: -1
  },
  {
